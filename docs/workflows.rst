...
.. note::
   ...
   * Workflows end with ``_wf``, and are generated by a function of the form
     ...
     :func:`~fmriprep.workflows.pet.base.init_pet_wf` names the
...
.. workflow::
    ...
    from fmriprep.workflows.pet.registration import init_bbreg_wf
    wf = init_bbreg_wf(
        omp_nthreads=1,
        use_bbr=True,
        pet2anat_dof=9,
...
See :func:`fmriprep.workflows.pet.registration.init_bbreg_wf` for further details.
...
See :func:`fmriprep.workflows.pet.registration.init_fsl_bbr_wf` for further details.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
:py:func:`~fmriprep.workflows.pet.resampling.init_pet_surf_wf`
...
HCP Grayordinates
~~~~~~~~~~~~~~~~~
:py:func:`~fmriprep.workflows.pet.resampling.init_pet_fsLR_resampling_wf`
...
~~~~~~~~~~~~~~~~~~~~
:py:func:`~fmriprep.workflows.pet.confounds.init_pet_confs_wf`
