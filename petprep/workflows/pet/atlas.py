...
def init_atlas_wf(
    atlas: str,
    config_file: str,
    tpl2anat_xfm: str | None,
    name: str = "pet_atlas_wf",
) -> Workflow:
    """Map a template atlas into T1w space and compute regional volumes.

    This workflow expects a transform from template space to anatomical
    space, typically generated by the anatomical workflow. If no transform
    is provided, a template-to-anatomical registration will be estimated as
    a fallback.
    ...
    tpl2anat_xfm : :class:`str`
        Transform from template space to T1w space. If ``None``, the workflow
        will estimate this registration internally.
    name : :class:`str`
    ...
    tpl2anat_xfm
        Transform from template space to T1w space, typically produced by
