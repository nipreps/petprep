0.0.10 (August 11, 2026)
========================

  * DOC: Add `CITATION.cff` file (#340)
  * MNT: Pin Hatchling below 1.32 for Twine compatibility (#341)
  * MNT: Raise minimum pytest-xdist version (#342)
  ...
  * DOC: add section on filtering anat input by BIDS entities (#335)
  ...
  * MNT: Add codespell support with configuration and fixes (#329)
